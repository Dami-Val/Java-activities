...
public class Automovil {
    ...
    public void conducir(){
        ...
        System.out.println("Ingrese la cantidad que kilometros que condujo en su ultima rodada: ");
        double incrementokilometraje = scanf.nextInt();
        double sum = incrementokilometraje + kilometraje;
        System.out.println("Su kilometraje incrementó de " + kilometraje + " Km a: " + sum + " Km.");
        kilometraje = sum;
